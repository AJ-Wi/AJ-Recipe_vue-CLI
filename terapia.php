...
<html lang="es">
	...
	<body>
		...
		<div class="ventana" >
			...
			<div class="cuerpo">
				<form method="post" action="conexion/terapia.php">
					<input type="hidden" name="id" value="<?php echo $ID; ?>" >
					<label for="terapia">Descripción:</label>
					<textarea name="terapia" required rows="19" cols="90"><?php echo $TERAPIA; ?></textarea>
